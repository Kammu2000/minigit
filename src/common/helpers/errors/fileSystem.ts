...
export class FileNotFoundError extends FileSystemError {
  ...
  constructor(path: string){
    super(`${ERROR_CODES.FILE_NOT_FOUND_ERROR}: ${path} file was not found in working directory`);
  }
}
...
export class DirectoryNotFoundError extends FileSystemError {
  ...
  constructor(path: string){
    super(`${ERROR_CODES.FILE_NOT_FOUND_ERROR}: ${path} directory was not found in working directory`);
  }
}
